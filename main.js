...
randomSketch = quickDrawDataSet[randomNumber];
console.log(randomSketch);
document.getElementById("currentSketch").innerHTML = "Draw this Sketch: <br> " + randomSketch;
...
function checkSketch() {
    ...
    document.getElementById("timerLabel").innerHTML = "Timer: " + timerCounter;
...
function gotResult(error, results) {
    if (error) {
        ...
        document.getElementById("yourSketch").innerText = "Your Sketch: " + drawnSketch;
